 ...
 */
@XmlRootElement
public class GolpesOrfaoDTO implements Serializable{
    ...
    public GolpesOrfaoDTO(){}
    
    public GolpesOrfaoDTO(Golpes golpe){
        this.id = golpe.getId();
    ...
    public GolpesOrfaoDTO(String nomeGolpe, String input, Personagens personagem) {
